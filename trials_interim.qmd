---
title: "Considerations for the planning, conduct and reporting of clinical trials with interim analyses: code accompanying the paper"
author: "Kaspar Rufibach, on behalf of the author team"
...
Code for the paper _Recommendations for the planning, conduct and reporting of clinical trials with interim analyses_, Asikanius et al. [-@asikanius_24], written by an author team of statisticians from regulators, academia, and industry.

# Purpose of this document

This R Quarto file provides easy accessible code to compute all the quantities in the paper. The github repository where this document is hosted is available [here](https://github.com/oncoestimand/trials_interim).
...
First, compute number of required events without interim:
